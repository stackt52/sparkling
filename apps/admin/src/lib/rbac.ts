...
const matrix: Record<Exclude<UserRole, 'customer' | 'technician'>, Set<Capability>> = {
  admin: new Set<Capability>([
    ...
    'view:loyalty', 'view:inventory', 'view:reports', 'view:config', 'view:audit', 'export:csv',
